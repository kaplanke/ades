...
namespace SVMDemo
{
    ...
    public partial class SVMCanvas : UserControl
    {
        ...
        public int PARAM_C = 2;
        public double PARAM_GAMMA = 0.5;
        public int PARAM_DEGREE = 3;
        public KernelType PARAM_KERNEL = KernelType.LINEAR;
        public double PARAM_COEFF = 0;
        ...
        private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            param.C = PARAM_C;
            param.Gamma = PARAM_GAMMA;
            // param.KernelType = KernelType.LINEAR;
            param.KernelType = PARAM_KERNEL;
            param.Degree = PARAM_DEGREE;
            param.Coefficient0 = PARAM_COEFF;
